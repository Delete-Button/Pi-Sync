...
IF "%DIRECTORY%"=="2" (scp -i PiServer -r Files-To-Send\ pi@192.168.240.239:~/ & ssh -i PiServer -t pi@192.168.240.239 "cd ~/; sudo mv -f Files-To-Send/ /usr/share/nginx/html/Theaterboards/; cd /usr/share/nginx/html/Theaterboards; sudo mv Files-To-Send/* .; sudo rm -rf Files-To-Send")
IF "%DIRECTORY%"=="3" (scp -i PiServer -r Files-To-Send\ pi@192.168.240.239:~/ & ssh -i PiServer -t pi@192.168.240.239 "cd ~/; sudo mv -f Files-To-Send/ /usr/share/nginx/html/Theaterboards/posters/; cd /usr/share/nginx/html/Theaterboards/posters/; sudo mv Files-To-Send/* .; sudo rm -rf Files-To-Send")
