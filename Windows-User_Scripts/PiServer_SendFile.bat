...
IF "%DIRECTORY%"=="3" (spc -r Files-To-Send\ pi@192.168.240.239:~/ & ssh -t pi@192.168.240.239 "cd ~/; sudo mv -f Files-To-Send/ /usr/share/nginx/html/Theaterboards/posters/; cd /usr/share/nginx/html/Theaterboards/posters/; sudo mv Files-To-Send/* .; sudo rm -rf Files-To-Send")
